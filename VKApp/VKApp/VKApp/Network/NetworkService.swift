...
class NetworkServise {
    ...
    init(){
        ...
        configuration = URLSessionConfiguration.default // Конфигурация по умолчанию
        session = URLSession(configuration: configuration) // собственная сессия
    }
    //MARK: - GET FRIENDS
    ...
    //MARK: - GET PHOTOS
    func getPhotos(owner_id: Int) {
        urlConstructor.path = "/method/photos.getAll"
        // параметры для запроса
        urlConstructor.queryItems = [
            URLQueryItem(name: "owner_id", value: String(owner_id)),
