...
class PresenterViewController: UIViewController {
    ...
    func setImage(){
        ...
        leftImageView.image = UIImage(named: photos[indexPhotoLeft].photoName)
        middleImageView.image = UIImage(named: photos[indexPhotoMid].photoName)
        rightImageView.image = UIImage(named: photos[indexPhotoRight].photoName)
